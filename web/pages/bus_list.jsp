                                ...
                                <ul class="nav nav-subnav">
                                    <c:if test="${not empty menu.list}">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li ><a href="${ctx}${menuItem.href}"><i class="${menuItem.icon}"></i>${menuItem.title}</a></li>
                                        </c:forEach>
                                    </c:if>
                                </ul>
                            </li>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 示例页面 - 商家列表 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="#!" role="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <input type="hidden" name="search_field" id="search-field" value="bussname">
                                        ...
                                        <input type="text" class="form-control" value="${keyword}" name="keyword" placeholder="请输入店铺名">
                                    </div>
                                </form>
                                <div class="toolbar-btn-action">
                                    ...
                                    <a class="btn btn-success m-r-5" onclick="enableBus()" href="#!"><i class="mdi mdi-check"></i> 启用</a>
                                    <a class="btn btn-warning m-r-5" onclick="disableBus()" href="#!"><i class="mdi mdi-block-helper"></i> 禁用</a>
                                    <a class="btn btn-danger" onclick="delBus()" href="#!"><i class="mdi mdi-window-close"></i> 删除</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="bus" items="${busList}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a data-toggle="modal" data-target="#editBus"
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="shopName" class="control-label">店铺名：</label>
                                                                <input type="text" class="form-control" id="shopName">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="bossName" class="control-label">店主名：</label>
...
<script type="text/javascript">
    ...
    function addBus(){
        type=1;
        document.getElementById("busForm").reset();//重置表单
        document.getElementById("exampleModalLabel").innerText="添加商家信息";
    }
    //编辑 得到所要编辑的数据
    function editBus(id){
        type=2;
        document.getElementById("busForm").reset();//重置表单
        document.getElementById("exampleModalLabel").innerText="修改商家信息";
        $.ajax({
            ...
            data:{
                ...
                if (res.code == 200) {
                    ...
                    document.getElementById("bossName").value=res.data.bossName;
    ...
    function deleteBus(id){
        if (confirm("确认删除?")) {
            $.ajax({
                url:"${ctx}/api/bus/updateBusStatus",
                type:"post",
                dataType:"json",
                data:{
                    id:id
...
<%--
    1、建表
    2、创建实体类entity（接口）
    3、建controller、dao(继承、接口)、service（接口）
    4、展示列表
    5、模态框
    6、增删改查
--%>
