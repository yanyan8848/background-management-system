          ...
          <ul class="topbar-right">
            <li class="dropdown dropdown-profile">
              ...
              <ul class="dropdown-menu dropdown-menu-right">
                ...
                <li> <a href="edit_pwd.jsp"><i class="mdi mdi-lock-outline"></i> 修改密码</a> </li>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form method="post" action="#!" class="site-form">
                  ...
                  <button type="submit" class="btn btn-primary" onclick="edit()">修改密码</button>
                </form>
...
<script type="text/javascript">
  ...
  function edit(){
    ...
    if (password == null || password == "" || password1 == null || password1 == "" || password2 == null || password2 == "") {
      alert("不能为空")
