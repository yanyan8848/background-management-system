            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 示例页面 - 用户列表 </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                <form class="pull-right search-bar" method="get" action="#!" role="form">
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <input type="hidden" name="search_field" id="search-field" value="usersname">
                                        ...
                                        <input type="text" class="form-control" value="${keyword}" name="keyword" placeholder="请输入昵称">
                                    </div>
                                </form>
                                <div class="toolbar-btn-action">
                                    ...
                                    <a class="btn btn-success m-r-5" onclick="enableUser()" href="#!"><i class="mdi mdi-check"></i> 启用</a>
                                    <a class="btn btn-warning m-r-5" onclick="disableUser()" href="#!"><i class="mdi mdi-block-helper"></i> 禁用</a>
                                    <a class="btn btn-danger" onclick="delUser()" href="#!"><i class="mdi mdi-window-close"></i> 删除</a>
                                </div>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="user" items="${userList}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>${user.sex}</td>
                                                <td>${user.avatar}</td>
                                                <td><fmf:formatDate value="${user.create}" pattern="yyyy年MM月dd日 HH:mm:ss"></fmf:formatDate> </td>
                                                <td>
...
<script type="text/javascript">
    ...
    function addUser(){
        ...
        document.getElementById("exampleModalLabel").innerText="添加用户信息";
    }
    //编辑
    ...
    function deleteUser(id){
        if (confirm("确认删除?")) {
            $.ajax({
                url:"${ctx}/api/user/updateUserStatus",
                type:"post",
                dataType:"json",
                data:{
                    id:id
